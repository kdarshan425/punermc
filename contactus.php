    ...
    <?php  include 'partials/header.php';?>
        ...
        <div class="vision">
            <div style="background:url(img/background.PNG);background-size: cover;background-attachment: fixed;" >
                <div style="padding-top:70px;" class="container">
                    <div style="padding:60px;" class="barred">
                        <center>
                            <h1 style="color:black;font-family: 'Quantico',sans-serif;">Contact Us</h1>
                        </center>
                    </div>
                </div>
            </div>
            ...
            <div style="padding-bottom: 40px;" class="container">
                <center>
                    <div style="padding-top:100px;padding-bottom:0px;max-width: 660px;">
                        <div class="container">
                            <h2 style="color:rgb(136, 31, 31);font-family: 'Raleway',sans-serif;font-weight: bold;">
                                Get in touch with us, we are happy to serve
                            </h2>
